 ...
 */
public class Day_05_IO_P3_XLSXHandler {
    String filePath;
    FileInputStream fileInputStream;
    XSSFWorkbook workbook;
    XSSFSheet sheet;

    public Day_05_IO_P3_XLSXHandler(String filePath) {
    ...
    public static void main(String[] args) {
        String path = "data/Data2.xlsx";

        Day_05_IO_P3_XLSXHandler xlsxHandler = new Day_05_IO_P3_XLSXHandler(path);

        xlsxHandler.printRowWise();
        xlsxHandler.printColumnWise();
    }
}
